...
\small
\begin{tabular}{l@{\hspace{0.5em}}c@{\hspace{0.5em}}c@{\hspace{0.5em}}c@{\hspace{0.5em}}c}
\hline
 & \begin{tabular}{c}ROC AUC\\(comp)\end{tabular} & \begin{tabular}{c}ROC AUC\\(best single)\end{tabular} & \begin{tabular}{c}PR AUC\\(comp)\end{tabular} & \begin{tabular}{c}TPR@5\% FPR\\(comp)\end{tabular} \\
\hline
